...
const Menu = ({pathname}) => {
  return (
    <nav className="fixed z-50 bottom-8 right-8 flex flex-col gap-2">
        <Link
            href="/dashboard/home"
            className="fixed top-8 right-8 group flex items-center justify-start w-[58px] h-[58px] rounded-xl 
      ...
      <Link
        href="/setting/system"
        className={`group relative flex flex-col items-center justify-center w-[58px] h-[58px] rounded-xl bg-white shadow-md transition-colors 
          ${pathname === "/setting/system" ? "text-blue-500" : "text-black"} 
          hover:text-blue-500`}
      ...
      >
        ...
        <p className="absolute bottom-2 opacity-0 text-sm font-semibold transition-opacity group-hover:opacity-100">
          System
        </p>
      </Link>
      ...
      <Link
        href="/setting/user"
        className={`group relative flex flex-col items-center justify-center w-[58px] h-[58px] rounded-xl bg-white shadow-md transition-colors 
          ${pathname === "/setting/user" ? "text-blue-500" : "text-black"} 
          hover:text-blue-500`}
      ...
      >
        ...
        <p className={`opacity-0 absolute bottom-2 text-sm font-semibold transition-opacity group-hover:opacity-100`}>
          User
        </p>
      </Link>
    </nav>

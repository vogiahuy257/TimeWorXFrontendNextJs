  ...
  return (
    <nav className="fixed z-50 bottom-8 right-8 flex flex-col gap-2">
        <button
            ...
            className="btn-menu-home fixed top-8 right-8 group flex items-center justify-start w-[54px] h-[54px] rounded-xl 
      ...
      <Link
        href="/setting/system"
        className={`btn-setting group relative flex flex-col items-center justify-center w-[54px] h-[54px] rounded-xl shadow-md transition-colors 

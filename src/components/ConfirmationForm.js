const ConfirmationForm = ({
    ...
    return (
        <div
            ...
            className={`${type} rounded-2xl pr-2 flex ${styleToBox}`}
        >
            <div className="w-1/4 h-full relative">
                {type == 'help' && (
                    <>
                        <svg
                            className="icon-confirmation absolute left-8 -translate-y-1/2"
                            id="icon-confirmation"
                            width="70"
                            height="70"
                            viewBox="0 0 78 78"
                            fill="none"
                        ...
                        >
                            <path
                                className="bg-icon-config"
                                fillRule="evenodd"
                                clipRule="evenodd"
                                d="M45.571 68.4064C46.0378 68.0508 46.579 67.8055 47.1492 67.6667C62.1698 64.0087 73.32 50.4665 73.32 34.32C73.32 15.3656 57.9544 0 39 0C20.0456 0 4.67999 15.3656 4.67999 34.32C4.67999 47.018 11.576 58.1053 21.8272 64.0412C22.5604 64.4658 23.1679 65.0833 23.5394 65.8447L28.2812 75.5654C29.3877 77.8339 32.2928 78.5231 34.3004 76.9935L45.571 68.4064Z"
                                fill="currentColor"
                            />
                            <ellipse
                                className="item-icon-config"
                                cx="38.8213"
                                cy="46.8696"
                                rx="2.43478"
                                ry="2.43478"
                    ...
                    <>
                        ...
                        >
                            <path
                                fillRule="evenodd"
                                clipRule="evenodd"
                                d="M47.8055 67.6794C48.1344 67.4706 48.4933 67.3124 48.8664 67.2006C63.0117 62.9621 73.3199 49.8448 73.3199 34.32C73.3199 15.3656 57.9543 0 38.9999 0C20.0455 0 4.67993 15.3656 4.67993 34.32C4.67993 47.8227 12.4777 59.5042 23.8158 65.1068C23.8286 65.1132 23.8233 65.1326 23.8091 65.1315C23.7999 65.1308 23.793 65.1396 23.7957 65.1483L26.9037 74.9903C27.6946 77.4949 30.6437 78.5705 32.8614 77.1631L47.8055 67.6794Z"
                                fill="#C81912"
                            />
                            <path
            ...
            <div className="w-3/4 flex flex-col justify-center h-ful items-end mx-6">
                <div>
                    ...
                    <p
                        className={`${type == 'error' ? 'ml-4 text-sm' : null} ${styleToChildren}`}
                    >
                        {children}
                    </p>
                </div>

...
const TaskForm = ({
    ...
    const handleUserClick = async () => {
        try {
            const response = await axios.get(`/api/v1/users/getall/tasks`)
    ...
    const convertDateFormat = dateStr => {
        ...
        // Return the final formatted date string in the format "yyyy-MM-ddThh:mm"
        ...
        <section id="task-form">
            <div className="task-form-container relative">
                    ...
                    <div className="task-form-header">
                        ...
                        <div className="flex items-center gap-1 px-1 pt-1">
                            ...
                            >
                                <path
                                    opacity="0.4"
                                    d="M16.8357 1.91003H7.19569C5.07569 1.91003 3.33569 3.65003 3.33569 5.77003V19.86C3.33569 21.66 4.62569 22.42 6.20569 21.55L11.0857 18.84C11.6057 18.55 12.4457 18.55 12.9557 18.84L17.8357 21.55C19.4157 22.43 20.7057 21.67 20.7057 19.86V5.77003C20.6957 3.65003 18.9657 1.91003 16.8357 1.91003Z"
                                    fill="currentColor"
                                />
                                <path
                                    d="M11.1057 13.2499C10.9157 13.2499 10.7257 13.1799 10.5757 13.0299L9.07565 11.5299C8.78565 11.2399 8.78565 10.7599 9.07565 10.4699C9.36565 10.1799 9.84565 10.1799 10.1357 10.4699L11.1057 11.4399L14.5757 7.96994C14.8657 7.67994 15.3457 7.67994 15.6357 7.96994C15.9257 8.25994 15.9257 8.73994 15.6357 9.02994L11.6357 13.0299C11.4857 13.1799 11.2957 13.2499 11.1057 13.2499Z"
                                    fill="currentColor"
                                />
                            </svg>
                    ...
                    <div className="task-form-button h-full">
                                            ...
                                            <div>
                                                ...
                                                <div className="mt-1 flex items-center gap-1">
                                                    ...
                                                    >
                                                        ...
                                                        />
                                                        <path
                                                            d="M17.74 4.81998C17.74 6.40998 16.44 7.70998 14.85 7.70998H10.15C8.56004 7.70998 7.26004 6.40998 7.26004 4.81998C7.26004 4.25998 6.66004 3.90998 6.16004 4.16998C4.75004 4.91998 3.79004 6.40998 3.79004 8.11998V17.53C3.79004 19.99 5.80004 22 8.26004 22H16.74C19.2 22 21.21 19.99 21.21 17.53V8.11998C21.21 6.40998 20.25 4.91998 18.84 4.16998C18.34 3.90998 17.74 4.25998 17.74 4.81998ZM12.88 16.95H8.50004C8.09004 16.95 7.75004 16.61 7.75004 16.2C7.75004 15.79 8.09004 15.45 8.50004 15.45H12.88C13.29 15.45 13.63 15.79 13.63 16.2C13.63 16.61 13.29 16.95 12.88 16.95ZM15.5 12.95H8.50004C8.09004 12.95 7.75004 12.61 7.75004 12.2C7.75004 11.79 8.09004 11.45 8.50004 11.45H15.5C15.91 11.45 16.25 11.79 16.25 12.2C16.25 12.61 15.91 12.95 15.5 12.95Z"
                                                            fill="currentColor"
                                                        />
                                                    </svg>
                                                    <p className="active-task-count text-xs font-light">
                                                        <strong>
                                                            Active Tasks:
                                                        </strong>{' '}
                                                        {
                        ...
                        {viewTaskToUser && (
                            <div className="h-3/5 task-box shadow-md rounded-lg p-4 my-3 relative flex justify-center items-center">
                                <h3 className=" absolute shadow-gray-200 shadow-md bg-black rounded-bl-md rounded-br-md text-white px-2 py-1 top-0 left-1/2 -translate-x-1/2 text-sm whitespace-nowrap">
                                    Tasks for {viewTaskToUser.name}
                                </h3>
                                <div className="w-full mt-4 max-h-52 overflow-y-auto scrollbar-hide">
                                    {Object.keys(viewTaskToUser.tasks).length >
                                    0 ? (
                                        Object.keys(viewTaskToUser.tasks).map(
                                            (projectName, index) => (
                                                <div
                                                    key={index}
                                                    className=" rounded-lg m-2 shadow-md overflow-hidden"
                                                >
                                                            ...
                                                            viewTaskToUser.tasks[
                                                                ...
                                                                (
                                                                    ...
                                                                    <li
                                                                        ...
                                                                        className="py-2 px-4 text-xs rounded-md truncate max-w-full overflow-hidden whitespace-nowrap"
                                                                    >
                                                                        {
                                                                            task.task_name
                                                                        }
                ...
                {confirmUser && (
                    ...
                    >
                        This ${confirmUser.name} already has too many tasks
                        assigned. Are you sure you want to add them to the
                        project?
                    </ConfirmationForm>
                )}
            </div>

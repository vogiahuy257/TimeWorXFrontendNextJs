                ...
                <div className="card-header relative">
                    <div className="text">
                        <div className="flex items-center">
                            <p className="w-full group-hover:w-3/4 h-auto break-words text-ellipsis truncate line-clamp-2">
                                {project.project_name}
                            </p>

                            <div className="hidden group-hover:flex gap-[6px] ml-auto">
                                <button
                        ...
                        <div className="custom-notification mt-auto flex items-center">
                            <div className="custom_complete relative flex gap-1 items-center">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    height="24"
                                    viewBox="0 -960 960 960"
                                    width="24"
                                    className='text-green-600 bg-green-300/50 rounded-md p-1'
                                    fill="currentColor"
                                >
                                ...
                                <p className='text-xs'>{project.completed_tasks_ratio}</p>
                            </div>

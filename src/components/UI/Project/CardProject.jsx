...
export default function CardProject({ project, formatDateRange, handleDelete,handleEdit}) {
    ...
    return (
        <div className={`card ${project.project_status || ''}`} key={project.project_id}>
            <Link className='card-form-view' href={`/dashboard/project/${project.project_id}`}>
                ...
                <div className='text'>
                    ...
                    <div className='card-form'>
                        ...
                        <div className='btn-form'>
                            <button className='btn card-form-edit' onClick={(e) => { 
                                e.stopPropagation()
                                e.preventDefault()
                                handleEdit(project)
                             }}>
                            ...
                            <button className='btn card-form-delete' onClick={(e) => { 
                                e.stopPropagation()
                                e.preventDefault()

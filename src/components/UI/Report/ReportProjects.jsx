export default function ReportProjects({projects, handleProjectClick,selectProject}) {
    return (
        <div className={`report-content report-project p-4 rounded-md shadow-md md:w-1/2 mx-auto relative`}>
                ...
                {projects.length > 0 ? (
                    projects.map(project => (
                        <button
                            ...
                            className={`py-2 rounded-md ${project.project_status} relative  ${selectProject && selectProject.project_id === project.project_id ? 'active' : ''}`}>
                            {selectProject.project_id == project.project_id ? (
                                <>
                                    ...
                                    {project.project_status?.toLowerCase() == 'done' ? (
                                        <svg

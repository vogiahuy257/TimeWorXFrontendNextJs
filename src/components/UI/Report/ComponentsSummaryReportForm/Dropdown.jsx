        ...
        <div className="relative w-full">
            ...
            >
                <div className='flex items-center'>
                    <span className={`w-2 h-2 rounded-full mr-2 ${selectedProject && styles[selectedProject.project_status]}`} />
                            ...
                            options.map(project => (
                                <li
                                    ...
                                    className={`flex items-center px-4 py-2 cursor-pointer hover:bg-blue-200 ${
                                        project.project_id === value ? 'bg-blue-200 font-medium' : ''
                                    }`}
                                    onClick={() => handleSelect(project.project_id)}
                                >
                                    {/* Status Indicator */}
                                    <span className={`w-2 h-2 rounded-full mr-2 ${styles[project.project_status]}`} />

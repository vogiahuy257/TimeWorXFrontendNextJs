                        ...
                        {options.find(opt => opt.project_id === value) ? (
                            <>
                                ...
                                <span className="ml-3 truncate">
                                    {
                                        options.find(
                                            opt => opt.project_id === value,
                                        )?.project_name
                                    }
                                </span>
                                <svg
                                    className={` ${isOpen ? 'active' : ''} ml-auto`}
                        ...
                        {options.length > 0 ? (
                            options.map(project => (
                                <li
                                    ...
                                    onClick={() =>
                                        handleSelect(project.project_id)
                                    }
                                    role="option"
                                ...
                                >
                                    <div className="flex items-center relative">
                                        ...
                                        />
                                        <span
                                            className={`ml-3 truncate ${project.project_id === value ? 'font-medium' : 'font-normal'}`}
                                        >

...
const ReportProjectDetail = ({ project }) => {
    ...
    return (
        <div className="project-detail">
            <h3 className="project-name shadow-md px-2 py-2 text-center break-words whitespace-normal">
                Your Project
            </h3>
            ...
            <div className="detail-content p-4 rounded-lg shadow-md flex">
                <div className="w-1/2 overflow-y-auto scrollbar-hide">
                    ...
                    <p className="text-xs mt-1 break-words whitespace-normal overflow-hidden">

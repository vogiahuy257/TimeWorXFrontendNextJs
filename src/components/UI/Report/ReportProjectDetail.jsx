            ...
            <div className="detail-content rounded-lg shadow-md flex flex-col-reverse md:flex-row ">
                <div className="md:w-1/2 w-full p-4 md:pl-4 flex flex-col justify-center gap-3 overflow-y-auto scrollbar-hide">
                    ...
                    <div className="flex justify-between">
                        {/* 🔴 Công việc bị trễ */}
                        <div className="flex-1 text-center bg-red-50 px-2 py-2 rounded-lg shadow-sm">
                        ...
                        <div className="flex-1 text-center bg-yellow-50 px-2 py-2 rounded-lg shadow-sm mx-2">
                        ...
                        {/* 🟢 Tỉ lệ hoàn thành */}
                        <div className="flex-1 text-center bg-green-50 px-2 py-2 rounded-lg shadow-sm">
                            <svg className='mx-auto mb-1' xmlns="http://www.w3.org/2000/svg" height="22px" viewBox="0 -960 960 960" width="22px" fill="#22c55e"><path d="m424-408-86-86q-11-11-28-11t-28 11q-11 11-11 28t11 28l114 114q12 12 28 12t28-12l226-226q11-11 11-28t-11-28q-11-11-28-11t-28 11L424-408Zm56 328q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z"/></svg>

...
const ReportProjectDetail = dynamic(
    () => import('@/components/UI/Report/ReportProjectDetail'),
    { ssr: false, loading: () => <p>Loading ReportProjectDetail...</p> },
)
const ReportTaskDone = dynamic(
    () => import('@/components/UI/Report/ReportTaskDone'),
    { ssr: false, loading: () => <p>Loading ReportTaskDone...</p> },
)
const SummaryReport = dynamic(
    () => import('@/components/UI/Report/SummaryReport'),
    { ssr: false, loading: () => <p>Loading SummaryReport...</p> },
)

const ReportTaskForm = dynamic(
    () => import('@/components/UI/Report/ReportTaskForm'),
    { ssr: false, loading: () => <p>Loading ReportTaskForm...</p> },
)
                    ...
                    <div className="m-4 w-full h-full flex flex-col lg:flex-row gap-4">
                        ...
                        <div className="gap-4 w-full h-full flex flex-col-reverse lg:w-1/2">
                            <div className="gap-4 flex flex-col md:flex-row">
                                <div
                                    className={`report-content report-project p-4 rounded-md shadow-md md:w-1/2 mx-auto`}
                                >
                                    ...
                                    <div className="project-box flex flex-wrap gap-4 p-2 mx-auto mt-4 w-auto rounded max-h-[290px] overflow-y-auto scrollbar-hide">
                                        {projects.map(project => (
                                            ...
                                            >
                                                ...
                                                <h3 className="w-full pb-1 break-words whitespace-nowrap overflow-hidden text-ellipsis truncate">
                                ...
                                <div className=" h-full report-content relative report-task-done rounded-md md:w-1/2">
                                    <h2 className="text-header text-report-done shadow-sm">
                                        Task Completed
                                    </h2>
                                    {/* Hiển thị task của project đã chọn */}
                                    <ReportTaskDone
                                        project_id={selectProject.project_id}
                                        onOpenReportTaskForm={
                                            openFormReportToTask
                                        }
                                    />
                                </div>
                            </div>
                            ...
                            <div
                                className={`h-52 report-content detail-box rounded-md relative`}
                            >
                                <ReportProjectDetail

...
export default function CircularMenu({setViewBoard,viewBoard}) {
        ...
        <div className='fixed p-5 bottom-0 right-0 flex items-center'>
            <div className=" relative flex">
                ...
                <motion.div
                    ...
                    <button 
                        className={`${viewBoard ? 'bg-blue-600/100 hover:bg-blue-600/90':'bg-black hover:bg-gray-800'} w-auto px-4 py-2 rounded-full shadow-md flex items-center justify-center transition`}
                ...
                <motion.div
                    ...
                    className="absolute bottom-4 right-4 rounded-full flex items-center justify-center text-white">
                    <button 
                        className={`${viewBoard ? 'bg-black hover:bg-gray-800' : 'bg-blue-600/100 hover:bg-blue-600/90'} w-auto px-4 py-2 rounded-full shadow-md flex items-center justify-center transition`}
                        onClick={() => { setViewBoard(false)}}
                    >

            ...
            <div className="block">
                ...
                <form onSubmit={submitForm}>
                    ...
                    >
                        ...
                        <InputError messages={errors.name} className="mt-2 text-xs text-start" id="name-error"/>
                    </div>
                    ...
                    >
                        ...
                        <InputError messages={errors.email} className="mt-2 text-xs text-start" id="email-error" />
                    </div>
                    ...
                    <div className={`block-element ${
                        ...
                        <InputError messages={errors.password} className="mt-2 text-xs text-start" id="password-error"/>
                    </div>
